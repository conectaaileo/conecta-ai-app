...
export default function Header() {
  ...
  const nav = [
    ...
    { label: "Meus aluguéis", href: "/meus-alugueis" }
  ];
    ...
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 ml-auto lg:ml-0">
          <button className="p-2 rounded-lg hover:bg-gray-100 text-gray-600" aria-label="Mensagens">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2v10z"/>
            </svg>
          </button>
          <button className="p-2 rounded-lg hover:bg-gray-100 text-gray-600" aria-label="Notificações">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
`;
fs.writeFileSync('components/Header.js', h, 'utf8');
console.log('Header.js criado com sucesso!');
